<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Addcategory.aspx.cs" Inherits="Delivery.Admin.Addcategory" %>
                    ...
                    <div class="panel-body">
                       <form  id="f2" runat="server"  class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                     <asp:TextBox ID="t1" runat="server" type="text" class="form-control"  placeholder="category Name"></asp:TextBox>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-4 col-sm-10">
                                    <asp:Button ID="b1" runat="server" class="btn btn-primary" Text="Add Category" OnClick="b1_Click" />
