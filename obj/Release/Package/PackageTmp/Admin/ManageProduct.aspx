<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageProduct.aspx.cs" Inherits="Delivery.Admin.ManageProduct" %>
                                        ...
                                        <asp:Repeater ID="rbr" runat="server">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td><%#Eval("price") %> $</td>
                                                    <td><%#Eval("[desc]") %></td>
                                                    <td><img src="images/<%#Eval("image") %>" class="img-circle" style="height: 50px;width: 50px;" /></td>
                                                    <td>
                                                        <a href="AddProduct.aspx" class="btn btn-primary"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></a>
                                                        </td>
                                                        <td>
                                                        <a href="deleteProduct.aspx?id=<%#Eval("pro_id") %>" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
