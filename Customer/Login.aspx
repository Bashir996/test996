<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Delivery.Customer.Login" %>
					...
					<div class="col-md-6">
						...
						<form id="f1" runat="server" class ="form-light mt-20" role="form">
							<div class="form-group">
                                ...
                                <asp:TextBox ID="t1" runat ="server" type="text" class="form-control" placeholder="User Name" ></asp:TextBox>
							</div>
									<div class="form-group">
										<label>Password</label>
                                      <asp:TextBox ID="t2" runat ="server" type="password" class="form-control" placeholder="Password" ></asp:TextBox>
									</div>
                            <div class="form-group">
                               
                            <asp:Button ID ="b1" runat="server" type="submit" class="btn btn-two" Text="Login" OnClick="b1_Click" />
                            <br />
